"""
Question-answer relevance evaluation using Google Gemini

Assesses whether a generated answer adequately addresses the user's question.
"""
...
# Wrap the LLM output into structured output
...
# Human prompt
# ---------------------------
human_prompt = """Please evaluate whether the generated answer properly addresses the user's question.
...
# Final Gemini-based runnable sequence
